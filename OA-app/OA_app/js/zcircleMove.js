...
// create by zcy 2016/10/10
	...
	function runCircle(settings){
		...
		var canvasC=document.getElementById(obj) || document.getElementsByClassName(obj)[0];
		// console.log(canvasC)
		/*控制运动*/
		...
		function CanvasApp(){
			...
			function drawScreen(){
				...
				context.lineWidth=lineW1;
				context.arc(0,0,30,0,startA,false);
				context.stroke();
				context.closePath();
